...
#ifndef BATCHFILTERSWIDGET_H
#define BATCHFILTERSWIDGET_H
...
/** \brief Main window for batch processing
  ...
  */
class BatchFiltersWidget : public QWidget
{
    Q_OBJECT

public:
	explicit BatchFiltersWidget(QWidget *parent = 0);
	~BatchFiltersWidget();
