...
QList<t_video_output_format> OpenCVFileVideoAcquisition::getOutputFormats()
{
...
int OpenCVFileVideoAcquisition::setOutputFormat(int id)
{
...
IplImage * OpenCVFileVideoAcquisition::readImage()
{
